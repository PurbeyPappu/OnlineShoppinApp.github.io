...
<html>
    ...
    <body style="background-color:#e3cacd">
        ...
        <div class="row mt-4">
         <div class="col-md-12">
          <div class="card-columns">
        	...
        	<img src="img/products/<%=p.getpPhoto() %>" style="max-height:100%; max-width:100% width:auto;" class="card-img-top m-2" alt="image is loading..">
